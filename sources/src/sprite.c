...
#define MAP_BOMBER_WOMAN "sprite/bomberwoman.png"
...
// bomb added
SDL_Surface* bomb_ttl1;
SDL_Surface* bomb_ttl2;
SDL_Surface* bomb_ttl3;
SDL_Surface* bomb_ttl4;
...
static void map_load() {
	...
	bomberwoman=image_load(MAP_BOMBER_WOMAN);
}
...
static void bomb_load() {
	bomb_ttl1 = image_load(BOMB_TTL1);
	bomb_ttl2 = image_load(BOMB_TTL2);
	bomb_ttl3 = image_load(BOMB_TTL3);
	bomb_ttl4 = image_load(BOMB_TTL4);
...
// rajout des sprite_get pour les bombes
SDL_Surface* sprite_get_bomb_ttl1() {
	assert(bomb_ttl1);
	return bomb_ttl1;
}

SDL_Surface* sprite_get_bomb_ttl2() {
	assert(bomb_ttl2);
	return bomb_ttl2;
}

SDL_Surface* sprite_get_bomb_ttl3() {
	assert(bomb_ttl3);
	return bomb_ttl3;
}

SDL_Surface* sprite_get_bomb_ttl4() {
	assert(bomb_ttl4);
	return bomb_ttl4;
}
